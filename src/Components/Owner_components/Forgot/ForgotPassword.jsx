...
const Emailverification = () => {
  ...
  const verify = async (email) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/owner/forgotpassword", {
        method: "POST",
...
useEffect(()=>{
  ...
  const verify = async (otp) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/owner/forgotpassword/otp", {
        method: "POST",
...
const ResetPaasword = () => {
  ...
  const verify = async (password) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/owner/forgotpassword/newpassword", {
        method: "PUT",
