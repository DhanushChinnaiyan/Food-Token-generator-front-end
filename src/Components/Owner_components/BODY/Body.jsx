    ...
    const fetchData = async () => {
      ...
      if (!ownerToken) {
        ...
        const customerResponse = await fetch(
          "https://food-token-generator-backend.vercel.app/customers",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
        ...
        const ordersResponse = await fetch(
          "https://food-token-generator-backend.vercel.app/ownertoken",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
        ...
        const profitResponse = await fetch(
          "https://food-token-generator-backend.vercel.app/profit",
          {
            method: "GET",
            headers: {
              "x-auth-ownertoken": ownerToken,
