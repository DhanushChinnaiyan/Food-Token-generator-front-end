...
const Emailverification = () => {
  ...
  const verify = async (email) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/customer/forgotpassword", {
        method: "POST",
...
const OtpVerification = () => {
  ...
  const verify = async (otp) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/customer/forgotpassword/otp", {
        method: "POST",
...
const ResetPaasword = () => {
  ...
  const verify = async (password) => {
    try {
      ...
      const response = await fetch("https://food-company-backend.onrender.com/customer/forgotpassword/newpassword", {
        method: "PUT",
