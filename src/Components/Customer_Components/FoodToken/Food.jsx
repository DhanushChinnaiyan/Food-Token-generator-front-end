...
const [loading,setLoading] = useState(false)
  ...
  return (
    <div className={loading?'customerFoodToken loading' : 'customerFoodToken'} >
      {
       loading? <CircularProgress size="calc(10px + 3vw)" color='error'/> : tokenEmpty ? <EmptyToken />
          :
          <Token
  ...
  return (
    <div>
      ...
      <div className="addtocartDiv">
        <img src={emptytoken} alt="CART IS EMPTY" />
      </div>
    </div>
  )
}
